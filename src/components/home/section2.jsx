    ...
    <section className="w-full bg-white py-12 md:pl-0 pl-12 md:py-16 px-4 md:px-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div className="text-[#5B8291] text-base md:text-lg lg:text-[20px] leading-relaxed">
          ...
          <p className="mt-6">
            He is certified by the European Board of Pediatrics He has previously worked in Department of Pediatrics in NMC Speciality Hospital Al Nahda Dubai for the past 14.5 years. Dr. Gaurav actively contributes to teaching, clinical audits and international research forums. Passionate about pediatric education and evidence-based practice, he continues to advance child health standards in the GCC region through compassionate care and lifelong learning.
          </p>
